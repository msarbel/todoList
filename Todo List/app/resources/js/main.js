...
//Get locally stored object list or use new empty version
...
var completeSVG = `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
// render after svg variables created
renderTodoList();

// on button click add input to list
...
// on enter key stroke add input to list
...
// loop through to render both lists if applicable 
...
function addItemTodo(text, completed) {
  ...
  complete.addEventListener('click', compeleteItem);
